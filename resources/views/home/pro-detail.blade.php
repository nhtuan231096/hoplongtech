...
<html lang="en-US" itemscope="itemscope" itemtype="http://schema.org/WebPage">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="{{url('public/home')}}/assets/css/colors/blue.css" media="all" />
                                        ...
                                        <li class="menu-item menu-item-object-static_block animate-dropdown">
                                            <div class="yamm-content">
                                                <div class="bg-yamm-content bg-yamm-content-bottom bg-yamm-content-right">
                                                    <div class="kc-col-container">
                                                        <div class="kc_single_image">
                                                            <img src="{{url('public/home')}}/assets/images/megamenu-1.jpg" class="" alt="" />
                                                        </div>
                                                        <!-- .kc_single_image -->
                                                    </div>
                                                    <!-- .kc-col-container -->
                                                ...
                                                <ul class="woocommerce-mini-cart cart_list product_list_widget ">
                                                    <li class="woocommerce-mini-cart-item mini_cart_item">
                                                        ...
                                                        <a href="single-product-sidebar.html">
                                                            <img src="{{url('public/home')}}/assets/images/products/mini-cart1.jpg" class="attachment-shop_thumbnail size-shop_thumbnail wp-post-image" alt="">XONE Wireless Controller&nbsp;
                                                        </a>
                                                    ...
                                                    <li class="woocommerce-mini-cart-item mini_cart_item">
                                                        ...
                                                        <a href="single-product-sidebar.html">
                                                            <img src="{{url('public/home')}}/assets/images/products/mini-cart2.jpg" class="attachment-shop_thumbnail size-shop_thumbnail wp-post-image" alt="">Gear Virtual Reality 3D with Bluetooth Glasses&nbsp;
                                                        </a>
                                                        <span class="quantity">1 ×
                                                            <span class="woocommerce-Price-amount amount">
                                                        ...
                                                        <figure class="woocommerce-product-gallery__wrapper ">
                                                            <div data-thumb="{{url('public/home')}}/assets/images/products/sm-card-1.jpg" class="woocommerce-product-gallery__image">
                                                                <a href="{{url('public/home')}}/assets/images/products/big-card.jpg" tabindex="0">
                                                                    <img width="600" height="600" src="{{url('public/home')}}/assets/images/products/big-card.jpg" class="attachment-shop_single size-shop_single wp-post-image" alt="">
                                                                </a>
                                                            </div>
                                                            <div data-thumb="{{url('public/home')}}/assets/images/products/sm-card-3.jpg" class="woocommerce-product-gallery__image">
                                                                <a href="{{url('public/home')}}/assets/images/products/big-card-2.jpg" tabindex="-1">
                                                                    <img width="600" height="600" src="{{url('public/home')}}/assets/images/products/big-card-2.jpg" class="attachment-shop_single size-shop_single" alt="">
                                                                </a>
                                                            </div>
                                                            <div data-thumb="{{url('public/home')}}/assets/images/products/sm-card-2.jpg" class="woocommerce-product-gallery__image">
                                                                <a href="{{url('public/home')}}/assets/images/products/big-card-1.jpg" tabindex="-1">
                                                                    <img width="600" height="600" src="{{url('public/home')}}/assets/images/products/big-card-1.jpg" class="attachment-shop_single size-shop_single" alt="">
                                                                </a>
                                                            </div>
                                                            <div data-thumb="{{url('public/home')}}/assets/images/products/deals-sm-5.jpg" class="woocommerce-product-gallery__image">
                                                                <a href="{{url('public/home')}}/assets/images/products/big-4.jpg" tabindex="-1">
                                                                    <img width="600" height="600" src="{{url('public/home')}}/assets/images/products/big-4.jpg" class="attachment-shop_single size-shop_single" alt=""> </a>
                                                            </div>
                                                            <div data-thumb="{{url('public/home')}}/assets/images/products/sm-card-2.jpg" class="woocommerce-product-gallery__image">
                                                                <a href="{{url('public/home')}}/assets/images/products/big-card-2.jpg" tabindex="-1">
                                                                    <img width="600" height="600" src="{{url('public/home')}}/assets/images/products/big-card-1.jpg" class="attachment-shop_single size-shop_single" alt="">
                                                ...
                                                <div class="techmarket-single-product-gallery-thumbnails" data-ride="tm-slick-carousel" data-wrap=".techmarket-single-product-gallery-thumbnails__wrapper" data-slick="{&quot;infinite&quot;:false,&quot;slidesToShow&quot;:4,&quot;slidesToScroll&quot;:1,&quot;dots&quot;:false,&quot;arrows&quot;:true,&quot;vertical&quot;:true,&quot;verticalSwiping&quot;:true,&quot;focusOnSelect&quot;:true,&quot;touchMove&quot;:true,&quot;prevArrow&quot;:&quot;&lt;a href=\&quot;#\&quot;&gt;&lt;i class=\&quot;tm tm-arrow-up\&quot;&gt;&lt;\/i&gt;&lt;\/a&gt;&quot;,&quot;nextArrow&quot;:&quot;&lt;a href=\&quot;#\&quot;&gt;&lt;i class=\&quot;tm tm-arrow-down\&quot;&gt;&lt;\/i&gt;&lt;\/a&gt;&quot;,&quot;asNavFor&quot;:&quot;#techmarket-single-product-gallery .woocommerce-product-gallery__wrapper&quot;,&quot;responsive&quot;:[{&quot;breakpoint&quot;:765,&quot;settings&quot;:{&quot;vertical&quot;:false,&quot;horizontal&quot;:true,&quot;verticalSwiping&quot;:false,&quot;slidesToShow&quot;:4}}]}">
                                                    <figure class="techmarket-single-product-gallery-thumbnails__wrapper">
                                                        <figure data-thumb="{{url('public/home')}}/assets/images/products/sm-card-1.jpg" class="techmarket-wc-product-gallery__image">
                                                            <img width="180" height="180" src="{{url('public/home')}}/assets/images/products/sm-card-1.jpg" class="attachment-shop_thumbnail size-shop_thumbnail wp-post-image" alt="">
                                                        </figure>
                                                        <figure data-thumb="{{url('public/home')}}/assets/images/products/sm-card-3.jpg" class="techmarket-wc-product-gallery__image">
                                                            <img width="180" height="180" src="{{url('public/home')}}/assets/images/products/sm-card-3.jpg" class="attachment-shop_thumbnail size-shop_thumbnail" alt="">
                                                        </figure>
                                                        <figure data-thumb="{{url('public/home')}}/assets/images/products/sm-card-2.jpg" class="techmarket-wc-product-gallery__image">
                                                            <img width="180" height="180" src="{{url('public/home')}}/assets/images/products/sm-card-2.jpg" class="attachment-shop_thumbnail size-shop_thumbnail" alt="">
                                                        </figure>
                                                        <figure data-thumb="{{url('public/home')}}/assets/images/products/big-4.jpg" class="techmarket-wc-product-gallery__image">
                                                            <img width="180" height="180" src="{{url('public/home')}}/assets/images/products/big-4.jpg" class="attachment-shop_thumbnail size-shop_thumbnail" alt="">
                                                        </figure>
                                                        <figure data-thumb="{{url('public/home')}}/assets/images/products/sm-card-2.jpg" class="techmarket-wc-product-gallery__image">
                                                            <img width="180" height="180" src="{{url('public/home')}}/assets/images/products/sm-card-2.jpg" class="attachment-shop_thumbnail size-shop_thumbnail" alt="">
                                                        </figure>
                                        ...
                                        <section class="related">
                                            ...
                                            <div class="products">
                                                ...
                                                <div class="product">
                                                    ...
                                                    <a href="single-product-fullwidth.html" class="woocommerce-LoopProduct-link">
                                                        <img src="{{url('public/home')}}/assets/images/products/16.jpg" width="224" height="197" class="wp-post-image" alt="">
                                                        <span class="price">
                                                            <ins>
                                                                <span class="amount"> </span>
                                                            </ins>
                                                ...
                                                <div class="product">
                                                    ...
                                                    <a href="single-product-fullwidth.html" class="woocommerce-LoopProduct-link">
                                                        <img src="{{url('public/home')}}/assets/images/products/8.jpg" width="224" height="197" class="wp-post-image" alt="">
                                                        <span class="price">
                                                            <ins>
                                                                <span class="amount"> </span>
                                                            </ins>
                                                ...
                                                <div class="product">
                                                    ...
                                                    <a href="single-product-fullwidth.html" class="woocommerce-LoopProduct-link">
                                                        <img src="{{url('public/home')}}/assets/images/products/11.jpg" width="224" height="197" class="wp-post-image" alt="">
                                                        <span class="price">
                                                            <ins>
                                                                <span class="amount"> </span>
                                                            </ins>
                                                ...
                                                <div class="product">
                                                    ...
                                                    <a href="single-product-fullwidth.html" class="woocommerce-LoopProduct-link">
                                                        <img src="{{url('public/home')}}/assets/images/products/10.jpg" width="224" height="197" class="wp-post-image" alt="">
                                                        <span class="price">
                                                            <ins>
                                                                <span class="amount"> </span>
                                                            </ins>
                                                ...
                                                <div class="product">
                                                    ...
                                                    <a href="single-product-fullwidth.html" class="woocommerce-LoopProduct-link">
                                                        <img src="{{url('public/home')}}/assets/images/products/15.jpg" width="224" height="197" class="wp-post-image" alt="">
                                                        <span class="price">
                                                            <ins>
                                                                <span class="amount"> </span>
                                                            </ins>
                                                ...
                                                <div class="product">
                                                    ...
                                                    <a href="single-product-fullwidth.html" class="woocommerce-LoopProduct-link">
                                                        <img src="{{url('public/home')}}/assets/images/products/6.jpg" width="224" height="197" class="wp-post-image" alt="">
                                                        <span class="price">
                                                            <ins>
                                                                <span class="amount"> </span>
                                                            </ins>
                                                ...
                                                <div class="product">
                                                    ...
                                                    <a href="single-product-fullwidth.html" class="woocommerce-LoopProduct-link">
                                                        ...
                                                        <img src="{{url('public/home')}}/assets/images/products/14.jpg" width="224" height="197" class="wp-post-image" alt="">
                                                        <span class="price">
                                                            <ins>
                                                                <span class="amount"> 262.81</span>
                                                            </ins>
                                                ...
                                                <div class="product">
                                                    ...
                                                    <a href="single-product-fullwidth.html" class="woocommerce-LoopProduct-link">
                                                        ...
                                                        <img src="{{url('public/home')}}/assets/images/products/2.jpg" width="224" height="197" class="wp-post-image" alt="">
                                                        <span class="price">
                                                            <ins>
                                                ...
                                                <div class="product">
                                                    ...
                                                    <a href="single-product-fullwidth.html" class="woocommerce-LoopProduct-link">
                                                        ...
                                                        <img src="{{url('public/home')}}/assets/images/products/7.jpg" width="224" height="197" class="wp-post-image" alt="">
                                                        <span class="price">
                                                            <ins>
                                                ...
                                                <div class="product">
                                                    ...
                                                    <a href="single-product-fullwidth.html" class="woocommerce-LoopProduct-link">
                                                        <img src="{{url('public/home')}}/assets/images/products/4.jpg" width="224" height="197" class="wp-post-image" alt="">
                                                        <span class="price">
                                                            <ins>
                                                                <span class="amount"> </span>
                                                            </ins>
                                                ...
                                                <div class="product">
                                                    ...
                                                    <a href="single-product-fullwidth.html" class="woocommerce-LoopProduct-link">
                                                        <img src="{{url('public/home')}}/assets/images/products/3.jpg" width="224" height="197" class="wp-post-image" alt="">
                                                        <span class="price">
                                                            <ins>
                                                                <span class="amount"> </span>
                                                            </ins>
                                                ...
                                                <div class="product">
                                                    ...
                                                    <a href="single-product-fullwidth.html" class="woocommerce-LoopProduct-link">
                                                        <img src="{{url('public/home')}}/assets/images/products/13.jpg" width="224" height="197" class="wp-post-image" alt="">
                                                        <span class="price">
                                                            <ins>
                                                                <span class="amount"> </span>
                                                            </ins>
                                                ...
                                                <div class="product">
                                                    ...
                                                    <a href="single-product-fullwidth.html" class="woocommerce-LoopProduct-link">
                                                        <img src="{{url('public/home')}}/assets/images/products/9.jpg" width="224" height="197" class="wp-post-image" alt="">
                                                        <span class="price">
                                                            <ins>
                                                                <span class="amount"> </span>
                                                            </ins>
                                                ...
                                                <div class="product">
                                                    ...
                                                    <a href="single-product-fullwidth.html" class="woocommerce-LoopProduct-link">
                                                        <img src="{{url('public/home')}}/assets/images/products/1.jpg" width="224" height="197" class="wp-post-image" alt="">
                                                        <span class="price">
                                                            <ins>
                                                                <span class="amount"> </span>
                                                            </ins>
                                                ...
                                                <div class="product">
                                                    ...
                                                    <a href="single-product-fullwidth.html" class="woocommerce-LoopProduct-link">
                                                        <img src="{{url('public/home')}}/assets/images/products/12.jpg" width="224" height="197" class="wp-post-image" alt="">
                                                        <span class="price">
                                                            <ins>
                                                                <span class="amount"> </span>
                                                            </ins>
                                                            ...
                                                            <div class="products">
                                                                <div class="product">
                                                                    <a class="woocommerce-LoopProduct-link woocommerce-loop-product__link" href="single-product-fullwidth.html">
                                                                        <img width="224" height="197" alt="" class="attachment-shop_catalog size-shop_catalog wp-post-image" src="{{url('public/home')}}/assets/images/products/8.jpg">
                                                                        <span class="price">
                                                                            <del>
                                                                                <span class="woocommerce-Price-amount amount">
                                                                                    <span class="woocommerce-Price-currencySymbol">$</span>1,239.99</span>
                                                                ...
                                                                <div class="product">
                                                                    <a class="woocommerce-LoopProduct-link woocommerce-loop-product__link" href="single-product-fullwidth.html">
                                                                        <img width="224" height="197" alt="" class="attachment-shop_catalog size-shop_catalog wp-post-image" src="{{url('public/home')}}/assets/images/products/16.jpg">
                                                                        <span class="price">
                                                                            <del>
                                                                                <span class="woocommerce-Price-amount amount">
                                                                                    <span class="woocommerce-Price-currencySymbol">$</span>1,239.99</span>
                                                                ...
                                                                <div class="product">
                                                                    <a class="woocommerce-LoopProduct-link woocommerce-loop-product__link" href="single-product-fullwidth.html">
                                                                        <img width="224" height="197" alt="" class="attachment-shop_catalog size-shop_catalog wp-post-image" src="{{url('public/home')}}/assets/images/products/14.jpg">
                                                                        <span class="price">
                                                                            <del>
                                                                                <span class="woocommerce-Price-amount amount">
                                                                                    <span class="woocommerce-Price-currencySymbol">$</span>1,239.99</span>
                                                                ...
                                                                <div class="product">
                                                                    <a class="woocommerce-LoopProduct-link woocommerce-loop-product__link" href="single-product-fullwidth.html">
                                                                        <img width="224" height="197" alt="" class="attachment-shop_catalog size-shop_catalog wp-post-image" src="{{url('public/home')}}/assets/images/products/4.jpg">
                                                                        <span class="price">
                                                                            <del>
                                                                                <span class="woocommerce-Price-amount amount">
                                                                                    <span class="woocommerce-Price-currencySymbol">$</span>1,239.99</span>
