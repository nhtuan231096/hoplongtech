...
<!-- Mirrored from transvelo.github.io/techmarket-html/home-v14.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 01 Nov 2018 04:18:50 GMT -->
...
<head>
        ...
        <link rel="shortcut icon" href="{{url('public/home')}}/assets/images/fav-icon.png">
        <!-- <link rel="stylesheet" href="{{url('public/slick/slick-theme.css.css')}}"> -->
                            ...
                            <nav id="primary-navigation" class="primary-navigation" aria-label="Primary Navigation" data-nav="flex-menu">
                                <ul id="menu-primary-menu" class="nav yamm">
                                    <li class="sale-clr yamm-fw menu-item animate-dropdown">
                                        <a title="Super deals" href="product-category.html">Trang chủ</a>
                                    </li>
                                    ...
                                    <li class="yamm-fw menu-item menu-item-has-children animate-dropdown dropdown">
                                        <a title="Pages" data-toggle="dropdown" class="dropdown-toggle" aria-haspopup="true" href="#">Maker <span class="caret"></span></a>
                                        <ul role="menu" class=" dropdown-menu">
                                    ...
                                    <li class="menu-item animate-dropdown">
                                        <a title="Logitech Sale" href="product-category.html">Dự án</a>
                                    </li>
                                    <li class="menu-item animate-dropdown">
                        ...
                        <div id="departments-menu" class="dropdown departments-menu">
                            ...
                            @foreach($categorys as $category)
                                <li class="yamm-tfw menu-item menu-item-has-children animate-dropdown dropdown-submenu">
                                    ...
                                    <ul role="menu" class=" dropdown-menu" style="min-height: 524.906px;">
                                        <li class="menu-item menu-item-object-static_block animate-dropdown" style="min-height: 524.906px;">
                                            <div class="yamm-content">
                                                <div class="bg-yamm-content bg-yamm-content-bottom bg-yamm-content-right">
                                                    <div class="kc-col-container">
                                                        <div class="kc_single_image">
                                                            <img src="{{url('uploads/category')}}/assets/images/megamenu.jpg" class="" alt="">
                                                        </div>
                                                        <!-- .kc_single_image -->
                                                    </div>
                                                    <!-- .kc-col-container -->
                                                    ...
                                                    <div class="col-md-6 col-sm-12">
                                                        <div class="kc-col-container">
                                                            <div class="kc_text_block">
                                                                <ul>
                                                                    <li class="nav-title">{{$child->title}}</li>
                                                                    @foreach($child->childs as $chil)
                                                                    <li><a href="shop.html">{{$chil->title}}</a></li>
																	@endforeach
                            ...
                            @endforeach
                                <li class="menu-item menu-item-type-custom animate-dropdown">
                                    <a title="Gadgets" href="landing-page-v1.html">Xem thêm</a>
                                </li>
                            </ul>
                        </div>
                        <!-- .departments-menu -->
                        ...
                        <div id="primary" class="content-area">
                            <main id="main" class="site-main">
                                    ...
                                    <div class="slider-block column-1">
                                        ...
                                        @foreach($sliders as $slider)
                                            <div class="slider-1">
                                                ...
                                                <div class="caption">
                                                    <div class="pre-title">{{$slider->title}} </div>
                                 ...
                                 @foreach($best_seller as $product)
								    <div class="product-category product">
                                        <a href="product-category.html">
                                            ...
                                            <h2 class="woocommerce-loop-category__title">Sản phẩm</h2>
                                        </a>
                                    </div>
                                  @endforeach
								  </section>
                                ...
                                <section class="section-single-carousel-with-tab-product type-2">
                                    <div class="row">
                                        <section class="column-1 section-double-carousel" id="section-double-carousel">
                                            ...
                                            <!-- .section-header -->
                                            <div class="products-carousel" data-ride="tm-slick-carousel" data-wrap=".products" data-slick="{&quot;infinite&quot;:false,&quot;slidesToShow&quot;:2,&quot;slidesToScroll&quot;:2,&quot;dots&quot;:false,&quot;arrows&quot;:true,&quot;prevArrow&quot;:&quot;&lt;a href=https://transvelo.github.io/"#\&quot;&gt;&lt;i class=\&quot;tm tm-arrow-left\&quot;&gt;&lt;\/i&gt;&lt;\/a&gt;&quot;,&quot;nextArrow&quot;:&quot;&lt;a href=https://transvelo.github.io/"#\&quot;&gt;&lt;i class=\&quot;tm tm-arrow-right\&quot;&gt;&lt;\/i&gt;&lt;\/a&gt;&quot;,&quot;appendArrows&quot;:&quot;#section-double-carousel .custom-slick-nav&quot;,&quot;responsive&quot;:[{&quot;breakpoint&quot;:750,&quot;settings&quot;:{&quot;slidesToShow&quot;:2,&quot;slidesToScroll&quot;:2}},{&quot;breakpoint&quot;:1400,&quot;settings&quot;:{&quot;slidesToShow&quot;:1,&quot;slidesToScroll&quot;:1}}]}">
                                            ...
                                            <div class="section-products-carousel-tabs-wrap">
                                                ...
                                                <div class="tab-content">
                                                    <div id="tab-5a0483f26f2dc0" class="tab-pane active" role="tabpanel">
                                                        <div class="products-carousel" data-ride="tm-slick-carousel" data-wrap=".products" data-slick="{&quot;infinite&quot;:false,&quot;slidesToShow&quot;:4,&quot;slidesToScroll&quot;:4,&quot;dots&quot;:false,&quot;arrows&quot;:false,&quot;prevArrow&quot;:&quot;&lt;a href=https://transvelo.github.io/"#\&quot;&gt;&lt;i class=\&quot;tm tm-arrow-left\&quot;&gt;&lt;\/i&gt;&lt;\/a&gt;&quot;,&quot;nextArrow&quot;:&quot;&lt;a href=https://transvelo.github.io/"#\&quot;&gt;&lt;i class=\&quot;tm tm-arrow-right\&quot;&gt;&lt;\/i&gt;&lt;\/a&gt;&quot;,&quot;responsive&quot;:[{&quot;breakpoint&quot;:800,&quot;settings&quot;:{&quot;slidesToShow&quot;:2,&quot;slidesToScroll&quot;:2}},{&quot;breakpoint&quot;:1200,&quot;settings&quot;:{&quot;slidesToShow&quot;:3,&quot;slidesToScroll&quot;:3}},{&quot;breakpoint&quot;:1400,&quot;settings&quot;:{&quot;slidesToShow&quot;:3,&quot;slidesToScroll&quot;:3}}]}">
                                                            <div class="container-fluid">
                                ...
                                <section id="section-products-carousel-6" class="section-landscape-products-carousel section-landscape-products-carousel-with-thumbnails">
                                    ...
                                    <!-- .section-header -->
                                    <div class="products-carousel landscape-featured-product" data-ride="tm-slick-carousel" data-wrap=".products" data-slick="{&quot;infinite&quot;:false,&quot;slidesToShow&quot;:2,&quot;slidesToScroll&quot;:2,&quot;dots&quot;:true,&quot;arrows&quot;:true,&quot;prevArrow&quot;:&quot;&lt;a href=https://transvelo.github.io/"#\&quot;&gt;&lt;i class=\&quot;tm tm-arrow-left\&quot;&gt;&lt;\/i&gt;&lt;\/a&gt;&quot;,&quot;nextArrow&quot;:&quot;&lt;a href=https://transvelo.github.io/"#\&quot;&gt;&lt;i class=\&quot;tm tm-arrow-right\&quot;&gt;&lt;\/i&gt;&lt;\/a&gt;&quot;,&quot;appendArrows&quot;:&quot;#section-products-carousel-6 .custom-slick-nav&quot;,&quot;responsive&quot;:[{&quot;breakpoint&quot;:1590,&quot;settings&quot;:{&quot;slidesToShow&quot;:1,&quot;slidesToScroll&quot;:1}}]}">
                                        <div class="container-fluid">
                                                    ...
                                                    <div class="landscape-product-card-featured product" style="width: 733px;">
                                                        <div class="media">
                                                            <div id="techmarket-product-gallery-5a0483f26fb5e1" class="techmarket-product-gallery techmarket-product-gallery--with-images techmarket-product-gallery--columns-4 images" data-columns="4">
                                                                <figure class="techmarket-wc-product-gallery__wrapper" data-ride="tm-slick-carousel" data-wrap=".techmarket-wc-product-gallery__wrapper" data-slick="{&quot;infinite&quot;:false,&quot;slidesToShow&quot;:1,&quot;slidesToScroll&quot;:1,&quot;dots&quot;:false,&quot;arrows&quot;:false,&quot;prevArrow&quot;:&quot;&lt;a href=https://transvelo.github.io/"#\&quot;&gt;&lt;i class=\&quot;tm tm-arrow-left\&quot;&gt;&lt;\/i&gt;&lt;\/a&gt;&quot;,&quot;nextArrow&quot;:&quot;&lt;a href=https://transvelo.github.io/"#\&quot;&gt;&lt;i class=\&quot;tm tm-arrow-right\&quot;&gt;&lt;\/i&gt;&lt;\/a&gt;&quot;,&quot;asNavFor&quot;:&quot;#techmarket-product-gallery-5a0483f26fb5e1 .techmarket-wc-product-gallery-thumbnails__wrapper&quot;}">
                                                                ...
                                                                <figure class="techmarket-wc-product-gallery-thumbnails__wrapper" data-ride="tm-slick-carousel" data-wrap=".techmarket-wc-product-gallery-thumbnails__wrapper" data-slick="{&quot;infinite&quot;:false,&quot;slidesToShow&quot;:3,&quot;slidesToScroll&quot;:1,&quot;dots&quot;:false,&quot;arrows&quot;:true,&quot;vertical&quot;:true,&quot;verticalSwiping&quot;:true,&quot;focusOnSelect&quot;:true,&quot;touchMove&quot;:true,&quot;prevArrow&quot;:&quot;&lt;a href=https://transvelo.github.io/"#\&quot;&gt;&lt;i class=\&quot;tm tm-arrow-up\&quot;&gt;&lt;\/i&gt;&lt;\/a&gt;&quot;,&quot;nextArrow&quot;:&quot;&lt;a href=https://transvelo.github.io/"#\&quot;&gt;&lt;i class=\&quot;tm tm-arrow-down\&quot;&gt;&lt;\/i&gt;&lt;\/a&gt;&quot;,&quot;responsive&quot;:[{&quot;breakpoint&quot;:767,&quot;settings&quot;:{&quot;vertical&quot;:false,&quot;verticalSwiping&quot;:false,&quot;slidesToShow&quot;:1}}],&quot;asNavFor&quot;:&quot;#techmarket-product-gallery-5a0483f26fb5e1 .techmarket-wc-product-gallery__wrapper&quot;}">
                                                                    <figure class="techmarket-wc-product-gallery__image">
                                                    ...
                                                    <div class="landscape-product-card-featured product" style="width: 733px;">
                                                        <div class="media">
                                                            <div id="techmarket-product-gallery-5a0483f26fb5e2" class="techmarket-product-gallery techmarket-product-gallery--with-images techmarket-product-gallery--columns-4 images" data-columns="4">
                                                                <figure class="techmarket-wc-product-gallery__wrapper" data-ride="tm-slick-carousel" data-wrap=".techmarket-wc-product-gallery__wrapper" data-slick="{&quot;infinite&quot;:false,&quot;slidesToShow&quot;:1,&quot;slidesToScroll&quot;:1,&quot;dots&quot;:false,&quot;arrows&quot;:false,&quot;prevArrow&quot;:&quot;&lt;a href=https://transvelo.github.io/"#\&quot;&gt;&lt;i class=\&quot;tm tm-arrow-left\&quot;&gt;&lt;\/i&gt;&lt;\/a&gt;&quot;,&quot;nextArrow&quot;:&quot;&lt;a href=https://transvelo.github.io/"#\&quot;&gt;&lt;i class=\&quot;tm tm-arrow-right\&quot;&gt;&lt;\/i&gt;&lt;\/a&gt;&quot;,&quot;asNavFor&quot;:&quot;#techmarket-product-gallery-5a0483f26fb5e2 .techmarket-wc-product-gallery-thumbnails__wrapper&quot;}">
                                                                    <figure class="techmarket-wc-product-gallery__image">
                                                                        <img width="600" height="600" src="{{url('public/home')}}/assets/images/garden/deal-1.jpg" alt="gallery-image">
                                                                    </figure>
                                                                    <figure class="techmarket-wc-product-gallery__image">
                                                    ...
                                                    <div class="landscape-product-card-featured product" style="width: 733px;">
                                                        <div class="media">
                                                            <div id="techmarket-product-gallery-5a0483f26fb5e3" class="techmarket-product-gallery techmarket-product-gallery--with-images techmarket-product-gallery--columns-4 images" data-columns="4">
                                                                <figure class="techmarket-wc-product-gallery__wrapper" data-ride="tm-slick-carousel" data-wrap=".techmarket-wc-product-gallery__wrapper" data-slick="{&quot;infinite&quot;:false,&quot;slidesToShow&quot;:1,&quot;slidesToScroll&quot;:1,&quot;dots&quot;:false,&quot;arrows&quot;:false,&quot;prevArrow&quot;:&quot;&lt;a href=https://transvelo.github.io/"#\&quot;&gt;&lt;i class=\&quot;tm tm-arrow-left\&quot;&gt;&lt;\/i&gt;&lt;\/a&gt;&quot;,&quot;nextArrow&quot;:&quot;&lt;a href=https://transvelo.github.io/"#\&quot;&gt;&lt;i class=\&quot;tm tm-arrow-right\&quot;&gt;&lt;\/i&gt;&lt;\/a&gt;&quot;,&quot;asNavFor&quot;:&quot;#techmarket-product-gallery-5a0483f26fb5e3 .techmarket-wc-product-gallery-thumbnails__wrapper&quot;}">
                                                                    <figure class="techmarket-wc-product-gallery__image">
                                                                        <img width="600" height="600" src="{{url('public/home')}}/assets/images/garden/deal-1.jpg" alt="gallery-image">
                                                                    </figure>
                                                                    <figure class="techmarket-wc-product-gallery__image">
                                                    ...
                                                    <div class="landscape-product-card-featured product" style="width: 733px;">
                                                        <div class="media">
                                                            <div id="techmarket-product-gallery-5a0483f26fb5e4" class="techmarket-product-gallery techmarket-product-gallery--with-images techmarket-product-gallery--columns-4 images" data-columns="4">
                                                                <figure class="techmarket-wc-product-gallery__wrapper" data-ride="tm-slick-carousel" data-wrap=".techmarket-wc-product-gallery__wrapper" data-slick="{&quot;infinite&quot;:false,&quot;slidesToShow&quot;:1,&quot;slidesToScroll&quot;:1,&quot;dots&quot;:false,&quot;arrows&quot;:false,&quot;prevArrow&quot;:&quot;&lt;a href=https://transvelo.github.io/"#\&quot;&gt;&lt;i class=\&quot;tm tm-arrow-left\&quot;&gt;&lt;\/i&gt;&lt;\/a&gt;&quot;,&quot;nextArrow&quot;:&quot;&lt;a href=https://transvelo.github.io/"#\&quot;&gt;&lt;i class=\&quot;tm tm-arrow-right\&quot;&gt;&lt;\/i&gt;&lt;\/a&gt;&quot;,&quot;asNavFor&quot;:&quot;#techmarket-product-gallery-5a0483f26fb5e4 .techmarket-wc-product-gallery-thumbnails__wrapper&quot;}">
                                                                    <figure class="techmarket-wc-product-gallery__image">
                                                                        <img width="600" height="600" src="{{url('public/home')}}/assets/images/garden/deal-1.jpg" alt="gallery-image">
                                                                    </figure>
                                                                    <figure class="techmarket-wc-product-gallery__image">
                                                    ...
                                                    <div class="landscape-product-card-featured product" style="width: 733px;">
                                                        <div class="media">
                                                            <div id="techmarket-product-gallery-5a0483f26fb5e5" class="techmarket-product-gallery techmarket-product-gallery--with-images techmarket-product-gallery--columns-4 images" data-columns="4">
                                                                <figure class="techmarket-wc-product-gallery__wrapper" data-ride="tm-slick-carousel" data-wrap=".techmarket-wc-product-gallery__wrapper" data-slick="{&quot;infinite&quot;:false,&quot;slidesToShow&quot;:1,&quot;slidesToScroll&quot;:1,&quot;dots&quot;:false,&quot;arrows&quot;:false,&quot;prevArrow&quot;:&quot;&lt;a href=https://transvelo.github.io/"#\&quot;&gt;&lt;i class=\&quot;tm tm-arrow-left\&quot;&gt;&lt;\/i&gt;&lt;\/a&gt;&quot;,&quot;nextArrow&quot;:&quot;&lt;a href=https://transvelo.github.io/"#\&quot;&gt;&lt;i class=\&quot;tm tm-arrow-right\&quot;&gt;&lt;\/i&gt;&lt;\/a&gt;&quot;,&quot;asNavFor&quot;:&quot;#techmarket-product-gallery-5a0483f26fb5e5 .techmarket-wc-product-gallery-thumbnails__wrapper&quot;}">
                                                                    <figure class="techmarket-wc-product-gallery__image">
                                                                        <img width="600" height="600" src="{{url('public/home')}}/assets/images/garden/deal-1.jpg" alt="gallery-image">
                                                                    </figure>
                                                                    <figure class="techmarket-wc-product-gallery__image">
                                ...
                                <section class="section-products-carousel" id="homev6-carousel-3">
                                    ...
                                    <!-- .section-header -->
                                    <div class="products-carousel 6-column-carousel" data-ride="tm-slick-carousel" data-wrap=".products" data-slick="{&quot;infinite&quot;:false,&quot;slidesToShow&quot;:6,&quot;slidesToScroll&quot;:6,&quot;dots&quot;:true,&quot;arrows&quot;:true,&quot;prevArrow&quot;:&quot;&lt;a href=https://transvelo.github.io/"#\&quot;&gt;&lt;i class=\&quot;tm tm-arrow-left\&quot;&gt;&lt;\/i&gt;&lt;\/a&gt;&quot;,&quot;nextArrow&quot;:&quot;&lt;a href=https://transvelo.github.io/"#\&quot;&gt;&lt;i class=\&quot;tm tm-arrow-right\&quot;&gt;&lt;\/i&gt;&lt;\/a&gt;&quot;,&quot;appendArrows&quot;:&quot;#homev6-carousel-3 .custom-slick-nav&quot;,&quot;responsive&quot;:[{&quot;breakpoint&quot;:750,&quot;settings&quot;:{&quot;slidesToShow&quot;:2,&quot;slidesToScroll&quot;:2}},{&quot;breakpoint&quot;:1200,&quot;settings&quot;:{&quot;slidesToShow&quot;:3,&quot;slidesToScroll&quot;:3}},{&quot;breakpoint&quot;:1400,&quot;settings&quot;:{&quot;slidesToShow&quot;:4,&quot;slidesToScroll&quot;:4}},{&quot;breakpoint&quot;:1700,&quot;settings&quot;:{&quot;slidesToShow&quot;:5,&quot;slidesToScroll&quot;:5}}]}">
                                        <div class="container-fluid">
                                            <div class="woocommerce columns-6">
                                                <div class="products">
                                                    <div class="product">
                        ...
                        <div id="secondary" class="widget-area" role="complementary">
                            ...
                            <div class="widget widget_techmarket_products_carousel_widget">
                                <section id="single-sidebar-carousel" class="section-products-carousel">
                                    ...
                                    <!-- .section-header -->
                                    <div class="products-carousel" data-ride="tm-slick-carousel" data-wrap=".products" data-slick="{&quot;infinite&quot;:false,&quot;slidesToShow&quot;:1,&quot;slidesToScroll&quot;:1,&quot;rows&quot;:4,&quot;slidesPerRow&quot;:1,&quot;dots&quot;:false,&quot;arrows&quot;:false,&quot;prevArrow&quot;:&quot;&lt;a href=https://transvelo.github.io/"#\&quot;&gt;&lt;i class=\&quot;tm tm-arrow-left\&quot;&gt;&lt;\/i&gt;&lt;\/a&gt;&quot;,&quot;nextArrow&quot;:&quot;&lt;a href=https://transvelo.github.io/"#\&quot;&gt;&lt;i class=\&quot;tm tm-arrow-right\&quot;&gt;&lt;\/i&gt;&lt;\/a&gt;&quot;,&quot;appendArrows&quot;:&quot;#single-sidebar-carousel .custom-slick-nav&quot;}">
                                        <div class="container-fluid">
                                            <div class="woocommerce columns-1">
                                                <div class="products">
                                                    ...
                                                    <div class="landscape-product-widget product">
                                                        <a class="woocommerce-LoopProduct-link" href="single-product-fullwidth.html">
                                                            <div class="media">
                                                                <img class="wp-post-image" src="{{url('public/home')}}/assets/images/garden/xs-1.html" alt="">
                                                                <div class="media-body">
                                                                    <span class="price">
                                                                        <ins>
                                                                            <span class="amount"> 50.99</span>
                        ...
                        <div class="row">
                            <div class="footer-contact">
                                <div class="footer-logo">
                                    <a href="home-v1.html" class="custom-logo-link" rel="home">
                                        <svg data-name="Layer 5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 188.67 26.64">
                                            <defs>
                                                <style>
                                                    .cls-1 {
                                                        fill: #fff
                                            ...
                                            <polygon class="cls-1" points="185.1 2.79 185.1 11.05 184.28 11.05 184.28 2.79 184.28 2.74 184.28 2.1 188.67 2.1 188.67 2.79 185.1 2.79"></polygon>
                                            <rect class="cls-1" x="180.65" y="2.1" width="2.84" height="0.69"></rect>
                                            <rect class="cls-1" x="175.3" y="5.99" width="2.87" height="0.69"></rect>
                                            <polygon class="cls-1" points="174.18 11.05 173.45 11.05 173.45 2.1 174.16 2.1 174.24 2.1 179.58 2.1 179.58 2.76 174.24 2.76 174.24 10.39 179.66 10.39 179.66 11.05 174.24 11.05 174.18 11.05"></polygon>
                                            <polygon class="cls-1" points="167.02 7.46 167.6 6.92 172.08 11.03 170.95 11.03 167.02 7.46"></polygon>
                                            <polygon class="cls-1" points="165.45 11.03 164.66 11.03 164.66 2.09 165.45 2.09 165.45 6.77 170.34 2.32 171.42 2.32 165.45 7.82 165.45 11.03"></polygon>
                                            <path class="cls-1" d="M163.81,11.56h-1s-0.4-.32-0.58-0.48l-1.1-1c-0.2-.19-0.56-0.54-0.56-0.54V8.92a2.91,2.91,0,0,0,2.9-2.35A2.75,2.75,0,0,0,160.8,3.3H157.6v8.26h-0.82v-9h4.09a3.45,3.45,0,0,1,.61,6.82C162.24,10.12,163.81,11.56,163.81,11.56Z" transform="translate(-1 -0.51)"></path>
                                            <polygon class="cls-1" points="152.71 3.76 148.66 8.5 151.67 8.5 151.67 9.16 148.09 9.16 146.47 11.05 145.55 11.05 153.2 2.05 153.52 2.05 153.52 11.05 152.71 11.05 152.71 3.76"></polygon>
                                            <polygon class="cls-1" points="143.65 3.72 140.38 7.08 140.38 7.11 140.38 7.1 140.36 7.11 140.36 7.08 137.1 3.72 137.1 11.05 136.31 11.05 136.31 2.05 136.57 2.05 140.38 5.98 144.18 2.05 144.44 2.05 144.44 11.05 143.65 11.05 143.65 3.72"></polygon>
                                            <ellipse class="cls-2" cx="141.46" cy="19.94" rx="5.15" ry="5.18"></ellipse>
                                            <path class="cls-1" d="M4.05,24.52A10.08,10.08,0,0,1,1,17.2q0-1.07,0-3.44t0-3.44a9.66,9.66,0,0,1,3-7.2Q7,0.51,12,.51a13.59,13.59,0,0,1,5.86,1.17,9.52,9.52,0,0,1,3.72,2.89A6.24,6.24,0,0,1,22.9,7.95a0.75,0.75,0,0,1-.22.55,0.8,0.8,0,0,1-.59.22H18.2a0.88,0.88,0,0,1-.56-0.15,1.25,1.25,0,0,1-.33-0.48A5.16,5.16,0,0,0,15.5,5.76,5.78,5.78,0,0,0,12,4.8,5.65,5.65,0,0,0,7.94,6.19,5.91,5.91,0,0,0,6.4,10.5q0,1.07,0,3.26T6.4,17A6.11,6.11,0,0,0,8,21.43,5.62,5.62,0,0,0,12,22.86a6.14,6.14,0,0,0,4.22-1.41,5.34,5.34,0,0,0,1.59-4.22V16.08H13.32a0.88,0.88,0,0,1-.89-0.89v-2a0.88,0.88,0,0,1,.89-0.89H22.2a0.9,0.9,0,0,1,.67.26,0.86,0.86,0,0,1,.26.63v3.92a10.17,10.17,0,0,1-1.37,5.35,9,9,0,0,1-3.88,3.5A13.33,13.33,0,0,1,12,27.15Q6.88,27.15,4.05,24.52Z" transform="translate(-1 -0.51)"></path>
                                            <path class="cls-1" d="M22.35,26.56A0.75,0.75,0,0,1,22.12,26l0.07-.33L31.08,1.8A1.33,1.33,0,0,1,32.41.88h4.07a1.34,1.34,0,0,1,1.33.92l8.88,23.87L46.77,26a0.72,0.72,0,0,1-.24.55,0.77,0.77,0,0,1-.54.22H42.7a1.07,1.07,0,0,1-1.07-.7l-1.7-4.48H29l-1.7,4.48a1.07,1.07,0,0,1-1.07.7H22.9A0.75,0.75,0,0,1,22.35,26.56Zm7.92-9.25h8.36L34.45,5.91Z" transform="translate(-1 -0.51)"></path>
                                            <path class="cls-1" d="M47.65,26.52a0.86,0.86,0,0,1-.26-0.63V1.8a0.94,0.94,0,0,1,.24-0.67A0.84,0.84,0,0,1,48.28.88h9.58A10.92,10.92,0,0,1,65,3a7.31,7.31,0,0,1,2.57,6,7.65,7.65,0,0,1-1.29,4.53,7.2,7.2,0,0,1-3.63,2.65L68,25.59a0.93,0.93,0,0,1,.11.41,0.72,0.72,0,0,1-.24.55,0.77,0.77,0,0,1-.54.22h-3.4A1.41,1.41,0,0,1,63,26.5a2.68,2.68,0,0,1-.59-0.72L57.68,17H52.61v8.88a0.86,0.86,0,0,1-.26.63,0.9,0.9,0,0,1-.67.26h-3.4A0.85,0.85,0,0,1,47.65,26.52Zm10.1-13.73a4.9,4.9,0,0,0,3.33-1A3.62,3.62,0,0,0,62.2,8.94,3.74,3.74,0,0,0,61.09,6a4.78,4.78,0,0,0-3.33-1H52.61v7.77h5.14Z" transform="translate(-1 -0.51)"></path>
                                            <path class="cls-1" d="M69.82,26.52a0.86,0.86,0,0,1-.26-0.63V1.8a0.94,0.94,0,0,1,.24-0.67A0.84,0.84,0,0,1,70.45.88h9q10.91,0,11.14,10.06,0.07,2.15.07,2.89t-0.07,2.85q-0.15,5.18-2.79,7.64t-8.16,2.46H70.45A0.85,0.85,0,0,1,69.82,26.52Zm9.66-4q3.07,0,4.44-1.37t1.44-4.55q0.07-2.22.07-2.78t-0.07-2.74a6.27,6.27,0,0,0-1.52-4.46,6.27,6.27,0,0,0-4.55-1.42H74.77V22.49h4.7Z" transform="translate(-1 -0.51)"></path>
                                            <path class="cls-1" d="M93.05,26.52a0.86,0.86,0,0,1-.26-0.63V1.8A0.94,0.94,0,0,1,93,1.14,0.84,0.84,0,0,1,93.68.88H110a0.89,0.89,0,0,1,.93.92V4.28a0.84,0.84,0,0,1-.26.65,0.94,0.94,0,0,1-.67.24H97.86v6.48h11.32a0.89,0.89,0,0,1,.93.92V14.9a0.84,0.84,0,0,1-.26.65,0.94,0.94,0,0,1-.67.24H97.86v6.7h12.43a0.94,0.94,0,0,1,.67.24,0.84,0.84,0,0,1,.26.65v2.52a0.84,0.84,0,0,1-.26.65,0.94,0.94,0,0,1-.67.24H93.68A0.85,0.85,0,0,1,93.05,26.52Z" transform="translate(-1 -0.51)"></path>
                                            <path class="cls-1" d="M113.33,26.52a0.86,0.86,0,0,1-.26-0.63V1.8a0.94,0.94,0,0,1,.24-0.67A0.84,0.84,0,0,1,114,.88h2.89a1.18,1.18,0,0,1,1.07.63L128.5,17.94V1.8a0.94,0.94,0,0,1,.24-0.67,0.84,0.84,0,0,1,.65-0.26h3.18a0.89,0.89,0,0,1,.93.92V25.85a0.9,0.9,0,0,1-.26.67,0.86,0.86,0,0,1-.63.26h-2.92a1.21,1.21,0,0,1-1.11-.63L118,10.09v15.8a0.89,0.89,0,0,1-.24.63,0.84,0.84,0,0,1-.65.26H114A0.85,0.85,0,0,1,113.33,26.52Z" transform="translate(-1 -0.51)"></path>
                                        </svg>
                                    </a>
                                </div>
                                            ...
                                            <div class="media-body">
                                                ...
                                                <div class="footer-payment-icons">
                                                    <ul class="list-payment-icons nav">
                                                        <li class="nav-item">
                                                            <img class="payment-icon-image" src="{{url('public/home')}}/assets/images/credit-cards/mastercard.svg" alt="mastercard" />
                                                        </li>
                                                        <li class="nav-item">
                                                            <img class="payment-icon-image" src="{{url('public/home')}}/assets/images/credit-cards/visa.svg" alt="visa" />
                                                        </li>
                                                        <li class="nav-item">
                                                            <img class="payment-icon-image" src="{{url('public/home')}}/assets/images/credit-cards/paypal.svg" alt="paypal" />
                                                        </li>
                                                        <li class="nav-item">
                                                            <img class="payment-icon-image" src="{{url('public/home')}}/assets/images/credit-cards/maestro.svg" alt="maestro" />
                                                        </li>
                                                    </ul>
                                                </div>
  ...
  <script src="{{url('public/home')}}/slick/slick.js" type="text/javascript" charset="utf-8"></script>
...
<!-- Mirrored from transvelo.github.io/techmarket-html/home-v14.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 01 Nov 2018 04:19:20 GMT -->
</html>